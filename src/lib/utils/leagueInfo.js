/*   STEP 1   */
export const leagueID = "1180097360531722240"; // your league ID
...
export const managers = [
     {
       ...
       "bio": "Rebranded in 2025, the Homemade Traders became the Gefrin Hoyin Gadgies to reflect the rich region of Northumbria from where their manager is from. Gefrin, pronounced yeavering, is old English literally meaning Hill of Goats, it was the centre of activity during the Northumbrian golden age and a major settlement going back to the Iron Age. While Hoyin' Gadgies is Northumbrian dialect for The Throwing Gentlemen. The team's logo represents a goat with Iron Age stone carvings and the Northumbrian Flag forming an H in the body of the goat while symbology of Northumbria from the 7th Century form the base of the G. Chris is a member of the Old Firm and RotW clans. Ranked 3rd in the Post Starter Draft Ranks and 5th in the most likely to win Year 1. The most successful manager from the Cascadian League with four wins, including a three-win streak from 2015-2017. The only manager to make a trade in every season since they were introduced. Will that success carry over into the world of Dynasty?",
